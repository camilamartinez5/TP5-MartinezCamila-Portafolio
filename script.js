...
/*Esto es perfecto para crear un boton de cambio o toggle entre dos estados. En este caso, parecerá que muestra u oculta contenido.
La clase bx-x probablemente, mostrara un icono de cruz, y bx-menu mostrara un icono de menu, representando esos dos estados.*/
...
let options = { /*Crea un objeto de opción vacío. */
  strings: ['Diseñadora Web', 'Desarrolladora Web'], /*Establece las cadenas de subtítulos. En este caso, dos opciones de carrera.*/
